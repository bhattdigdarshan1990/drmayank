            ...
            <div className="grid md:grid-cols-12 gap-0">
              <div className="md:col-span-5 relative h-[400px] md:h-auto overflow-hidden">
                <img 
                  src={drAmeta} 
                  alt="Dr. Mayank Ameta" 
                  className="absolute inset-0 w-full h-full object-contain object-top bg-white dark:bg-slate-800"
                />
              </div>
              <div className="md:col-span-7 p-8 md:p-12 lg:p-16">
                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Dr. Mayank Ameta</h2>
                <p className="text-teal-600 dark:text-teal-400 font-medium text-lg mb-6">Consultant Gastroenterologist & Hepatologist</p>
                
                <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed mb-8 text-justify">
                  <p>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="flex items-start">
                    <div className="bg-teal-50 dark:bg-teal-900/30 p-3 rounded-lg text-teal-600 dark:text-teal-400 mr-4">
                      <Award size={24} />
                    </div>
                    <div>
                      <h4 className="font-bold text-slate-900 dark:text-white">Qualifications</h4>
                      <p className="text-sm text-slate-600 dark:text-slate-400">MBBS, MD, DM (Gastro)</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-teal-50 dark:bg-teal-900/30 p-3 rounded-lg text-teal-600 dark:text-teal-400 mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-400">10+ Years in Practice</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-white dark:bg-slate-950">
        <div className="max-w-screen-2xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div 
              {...fadeIn}
              className="bg-blue-50 dark:bg-blue-900/20 p-10 rounded-3xl border border-blue-100 dark:border-blue-900/30"
            >
              <Target className="text-blue-600 dark:text-blue-400 mb-6" size={40} />
            ...
            <motion.div 
              ...
              className="bg-emerald-50 dark:bg-emerald-900/20 p-10 rounded-3xl border border-emerald-100 dark:border-emerald-900/30"
            >
              <Users className="text-emerald-600 dark:text-emerald-400 mb-6" size={40} />
